...
<div id="base-carrinho">
	<h2 class="fundo_cor"> <img src="<?php echo pg ?>/imagens/barra-carrinho01.png"> </h2>
	<h3> <img src="<?php echo pg ?>/imagens/meu-carrinho.png"> </h3>
	<div class="dados-carrinho">
	<span> Para <strong style="color:#f00; font-weight:bold; font-size:14px;">excluir</strong> coloque a quantidade zero e clique em alterar </span>
			...
			<?php
				...
				$valorTotal = 0;
					for($i=0;$i<$totalReg;$i++){
						...
						if(trim($carrinho->getImagemProduto())==""){
							$url_carr_img_produto = pg ."/admin/fotos/sem-imagem.png";
						}else{
							$url_carr_img_produto = pg ."/admin/fotos/".$carrinho->getImagemProduto();
						}
			
			?>
				<tr>
					<td>
						<img src="<?php echo $url_carr_img_produto ?>" width="92" height="139"> 
					...
					<td><?php echo "R$ " .number_format($carrinho->getPreco(),2,',','.'); ?> </td>
...
<?php } else{ ?>
	...
	<p> Não existe nenhum item no seu carrinho de compras! </p> <br />
